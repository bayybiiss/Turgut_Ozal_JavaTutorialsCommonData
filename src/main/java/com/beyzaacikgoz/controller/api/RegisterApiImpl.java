package com.beyzaacikgoz.controller.api;
import com.beyzaacikgoz.business.dto.RegisterDto;
import com.beyzaacikgoz.business.services.IRegisterService;
import com.beyzaacikgoz.controller.IRegisterApi;
import com.beyzaacikgoz.error.ApiResult;
...
public class RegisterApiImpl implements IRegisterApi{
    ...
    // FIND
    // http://localhost:8080/api/v1/register
    // http://localhost:8080/api/v1/register/0
    ...
    public ResponseEntity<?>  getFindByRegister( @PathVariable(name="id",required = false) Long id) {
        if(id==null){
            ...
            ApiResult apiResult= ApiResult.builder()
                    ...
                    .path("http://localhost:8080/register/-1")
                    .build();
