package com.beyzaacikgoz.springboot._1_SpringMVC;
...
public class ControllerThymeleaf {
    ...
    //http://localhost:4444/mvc/v1/thymeleaf0
    @GetMapping("/thymeleaf0")
    @ResponseBody
    public String thymeleaf0(){
        return "Merhabalar Thymeleaf 0";
    }
    ...
    public String thymeleaf2(Model model){
        model.addAttribute("key2","Merhabalaar ben Javadan geldim");
    ...
    public String thymeleaf3(Model model){
        RegisterDto registerDto= RegisterDto.builder()
                ...
                .name("Beyza")
                .surname("Açıkgöz")
                .email("beyza-ecem2001@hotmail.com")
                .password("0123456789")
                .build();
    ...
    //http://localhost:4444/mvc/v1/thymeleaf4
    ...
    public String thymeleaf4(Model model){
        ...
        for (int i=1; i<=10; i++){
            RegisterDto registerDto= RegisterDto.builder()
                    ...
                    .name("Beyza" +i)
                    .surname("Açıkgöz" +i)
                    .email("beyza-ecem2001@hotmail.com"+i)
                    .password("0123456789"+i)
